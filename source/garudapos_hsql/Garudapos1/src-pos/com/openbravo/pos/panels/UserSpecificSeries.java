           ...
           for(int i=0;i<roleslist.size();i++){
               RoleInfo rinfo=roleslist.get(i);
                Object[] obj2=(Object[])   new StaticSentence(m_App.getSession()
                       ...
                       ,new SerializerReadBasic(new Datas[] {Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING,Datas.IMAGE,Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.TIMESTAMP})).find(rinfo.getName());
 ...
 public boolean deactivate() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       bill="R";
        ...
        if(flag1==0){
        Object[] values = new Object[] {id,jComboBox1.getSelectedItem().toString(),jComboBox2.getSelectedItem().toString(),receipt,receiptmax,bill,billmax,qt,qtmax,d,true};
        ...
        new PreparedSentence(m_App.getSession()
         ...
         new StaticSentence(m_App.getSession()
                        ...
                        .exec(new Object[] {jComboBox2.getSelectedItem().toString(),jComboBox1.getSelectedItem().toString(),d});
          jButton2.setVisible(false);
          if(sales==1){
    ...
    if(sales==1){
         ...
         Object[] obj=(Object[])   new StaticSentence(m_App.getSession()
                       ...
                       ,new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.STRING})
                       ,new SerializerReadBasic(new Datas[] { Datas.STRING,Datas.DOUBLE, Datas.STRING,Datas.DOUBLE,Datas.STRING,Datas.DOUBLE})).find(new Object[]{jComboBox2.getSelectedItem().toString(),jComboBox1.getSelectedItem().toString()});
       if(obj!=null){
           if(obj[0]!=null){
