   ...
   base.$allKeys
   	...
   	.bind('mouseenter.keyboard mouseleave.keyboard', function(e){
   		var el = this, $this = $(this),
   			// 'key' = { action: doAction, original: n, curTxt : n, curNum: 0 }
   			key = $.data(el, 'key');
   		if (e.type === 'mouseenter' && base.el.type !== 'password1' && !$this.hasClass(o.css.buttonDisabled) ){
   			$this
   				.addClass(o.css.buttonHover)
   				.attr('title', function(i,t){
   					// show mouse wheel message
   		...
   		if (e.type === 'mouseleave'){
   			...
   			$.data(el, 'key', key);
   			$this
   				.removeClass( (base.el.type === 'password1') ? '' : o.css.buttonHover) // needed or IE flickers really bad
   				.attr('title', function(i,t){ return (t === o.wheelMessage) ? '' : t; })
   				.find('span').text( key.original ); // restore original button text
   		}
   	})
       ...
       <table border="0" >
        ...
        <table border="1" >
                <tr>
                    ...
                    <table>
                        <tr> <div style="color: teal; font-size: xx-large; font-style: italic; font-family: monospace; " >
						...
						<label id="userName" ><s:text   name="Welcome  "/><s:property value="#session.user.name"/></label>
                                ...
                                <br />
                                        <table>    
                                            <tr>
                                                <th>
                            <s:form action="restPass.action" method="post"  name="frm" theme="simple" >    
                            
                            	<div id="myDiv" >
								<div class="label"><s:text   name="Old Password:"/></div>
								<div class="input"><input type="password" name="bean.opass"  theme="simple"  id="keyboard" name="login" value="#session.user.password1" onmouseover="keyUsername()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
								<div> <s:fielderror fieldName="bean.opass" theme="simple"/></div>
                            	...
                            	<s:actionerror  />
								<div>
								<div class="label"><s:text   name="New Password:"/></div>
								<div class="input"><input type="password" name="bean.npass"  theme="simple"  id="password" name="Password" value="" onmouseover="keyPassword()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
								<div> <s:fielderror fieldName="bean.npass" theme="simple"/></div>
                            	...
                            	<br />
                            	<div>
								<div class="label"><s:text   name="Confirm Password:"/></div>
								<div class="input"><input type="password" name="bean.cpass"  theme="simple"  id="password1" name="Password1" value="" onmouseover="keyPassword1()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
								<div> <s:fielderror fieldName="bean.cpass" theme="simple"/></div>
								<div id="passwordError"></div>
								</div>
								<br />
								<br /><br />
                  
                                       <!--   <img src="resources/back_icon.jpg" title="Click here to Go Back"  style="position: relative; margin-left: 20%;"  onclick="location.href='index.jsp'" /> &nbsp;&nbsp;&nbsp; -->
                             <img src="resources/Submit.png" onmouseover="this.src='resources/Submit_mo.png';" onmouseout="this.src='resources/Submit.png';" alt="Submit" onclick="frm.submit()" style="margin-right: -70px;"> &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
