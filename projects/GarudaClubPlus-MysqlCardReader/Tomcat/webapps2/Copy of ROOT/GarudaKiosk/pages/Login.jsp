                    ...
                    <table>
                        <tr>
                            <th>
                                        ...
                                        <table>    
                                            <tr>
                                               <th><s:form name = "loginForm" action="login.action" method="post" theme="simple" >    
                            
                            	<div>
								<div class="label"><s:text   name="Membership No:"/></div>
								<div class="input"><input type="text" name="bean.searchkey"  theme="simple"  id="keyboard" name="login" value="" onmouseover="keyUsername()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
								...
								<div class="input"><input type="password" name="bean.password"  theme="simple"  id="password" name="Password" value="" onmouseover="keyPassword()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
