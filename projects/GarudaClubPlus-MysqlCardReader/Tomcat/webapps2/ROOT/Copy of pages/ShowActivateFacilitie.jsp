<%-- 
    ...
    Author     : user
--%>
<%@page import="com.openbravo.pos.pda.struts.beans.ActivateInfo,java.util.HashMap,java.util.ArrayList"  %>
	...
	windowOnloadFunction(panelOneObjList, panelTwoObjList, advPanelListt)
     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"  > 
        ...
        <table border="1" >
            ...
            <%     ActivateInfo ainfo = (ActivateInfo) request.getSession().getAttribute("atinfo");
        ...
        if (suc[0] != null && fai[0] == null) {
            out.println("<font color='red'>Your activation request is sent to manager approval for <br/>");
            ...
            out.println("<font color='red'>You have already sent a request for  <br/>");
