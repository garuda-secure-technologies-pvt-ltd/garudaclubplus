						...
						<label id="userName" ><s:text   name="Welcome  "/><s:property value="#session.user.name"/></label>
                                ...
                                <br />
                                        <table>    
                                            <tr>
                                                <th>
                            <s:form name = "submitNewPassword" action="submitNewPassword.action" method="post" theme="simple" >    
                            
                            	<div>
								<div class="label"><s:text   name="Old Password:"/></div>
								<div class="input"><input type="password" name="bean.opass"  theme="simple"  id="keyboard" name="login" value="" onmouseover="keyUsername()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
            				...
            				<img src="resources/Submit.png" onmouseover="this.src='resources/Submit_mo.png';" onmouseout="this.src='resources/Submit.png';" alt="Submit" onclick="submitNewPassword.submit()" />
