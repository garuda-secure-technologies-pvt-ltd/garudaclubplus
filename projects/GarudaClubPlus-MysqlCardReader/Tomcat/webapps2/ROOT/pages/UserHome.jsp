                    ...
                    <div class="errorMessage" >
                        ...
                        <tr style="height: 65%">
                            <th>
            											...
            											<a href="guestEntry.action" > <img src="resources/guestentry.png" onmouseover="this.src='resources/guestentry_mo.png';" onmouseout="this.src='resources/guestentry.png';"  alt="Guest Entry" border="0"/></a>&nbsp;&nbsp;
            											<a href="changePassword.action" > <img src="resources/resetpass.png" onmouseover="this.src='resources/resetpass_mo.png';" onmouseout="this.src='resources/resetpass.png';"  alt="Resetpass" border="0"/></a><br /><br/>
            											<a href="partyHallBooking.action" > <img src="resources/PartyHall.png" onmouseover="this.src='resources/PartyHall_mo.png';" onmouseout="this.src='resources/PartyHall.png';"  alt="Hall & Room" border="0"/></a>&nbsp;&nbsp;
