                     ...
                     <tr>
                       <th>
                            <s:form action="restPass.action" method="post"  name="frm" theme="simple" >    
								...
								<input type="password" name="bean.opass"  theme="simple"  id="keyboard" name="login" value="#session.user.password1" class="keyboardInput" onfocus="enable()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;"/>
								...
								<input type="password" name="bean.npass"  theme="simple"  id="password" name="Password" value="" class="keyboardInput" onfocus="enable1()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;"/>
								...
								<input type="password" name="bean.cpass"  theme="simple"  id="password1" name="Password1" value="" class="keyboardInput" onfocus="enable2()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;"/>
