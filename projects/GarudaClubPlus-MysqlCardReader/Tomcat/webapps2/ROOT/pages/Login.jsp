                         ...
                         <table>
                             <tr>
                                ...
                                <marquee behavior="alternate"> 
                                                            <label id="userName" class="marqueEffect"><s:text   name="Welcome To Garuda Kiosk "/></label>
                                                            </marquee>
                                </div>
                                </th>
                             </tr>
                                    ...
                                    <tr style="height: 65%">
                                        <th>
                                               ...
                                               <s:form name = "loginForm" action="login.action" method="post" theme="simple" >    
                            
                            	
								<div class="label"><s:text   name="Membership No:"/></div>
								<input type="text" name="bean.searchkey"  theme="simple"  id="keyboard" name="login" value="" class="keyboardInput" onfocus="enable()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;"/>
                            	...
                            	<s:actionerror  />
								<div>
								<div class="label"><s:text   name="Password:"/></div>
								<input type="password" name="bean.password"  theme="simple"  id="password" name="Password" value="" class="keyboardInput"  onfocus="enable1()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;" />
								<div> <s:fielderror fieldName="bean.password" theme="simple"/></div>
                  			...
                  			<img src="resources/Submit.png" onmouseover="this.src='resources/Submit_mo.png';" onmouseout="this.src='resources/Submit.png';" alt="Submit"  onclick="loginForm.submit()"/>
