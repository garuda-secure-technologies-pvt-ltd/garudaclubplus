/*
 * Generated by JasperReports - 02/03/13 11:27
 */
 ...
 *
 */
public class NoticeToMembers_MemWiseReport_1362203859000_386610 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 39 : 
            {
                value = (java.lang.String)(((java.lang.String)field_noticeName.getValue()) + "  dated:  "+((java.lang.String)field_generatedDate.getValue())+",  Due Date: "+ ((java.lang.String)field_dueDate.getValue())+",  PayBy Date: "//$JR_EXPR_ID=39$
+((java.lang.String)field_payByDate.getValue())+",  Due Amount: " + ((java.lang.Double)field_dueAmount.getValue())+".  Communication Mode:  " +((java.lang.String)field_commMode.getValue())+//$JR_EXPR_ID=39$
"  , Date of Dispatch: " + ((java.lang.String)field_dateOfDispatch.getValue())+", Received Reference: " + ((java.lang.String)field_receivedRef.getValue())//$JR_EXPR_ID=39$
+" ,  Received By:  " + ((java.lang.String)field_recBy.getValue()) + "  , Received Date:  "+ ((java.lang.String)field_recDate.getValue())+ "  ,  Notice Status:  " +((java.lang.String)field_status.getValue())+" .");//$JR_EXPR_ID=39$
                break;
            }
            case 40 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 39 : 
            {
                value = (java.lang.String)(((java.lang.String)field_noticeName.getOldValue()) + "  dated:  "+((java.lang.String)field_generatedDate.getOldValue())+",  Due Date: "+ ((java.lang.String)field_dueDate.getOldValue())+",  PayBy Date: "//$JR_EXPR_ID=39$
+((java.lang.String)field_payByDate.getOldValue())+",  Due Amount: " + ((java.lang.Double)field_dueAmount.getOldValue())+".  Communication Mode:  " +((java.lang.String)field_commMode.getOldValue())+//$JR_EXPR_ID=39$
"  , Date of Dispatch: " + ((java.lang.String)field_dateOfDispatch.getOldValue())+", Received Reference: " + ((java.lang.String)field_receivedRef.getOldValue())//$JR_EXPR_ID=39$
+" ,  Received By:  " + ((java.lang.String)field_recBy.getOldValue()) + "  , Received Date:  "+ ((java.lang.String)field_recDate.getOldValue())+ "  ,  Notice Status:  " +((java.lang.String)field_status.getOldValue())+" .");//$JR_EXPR_ID=39$
                break;
            }
            case 40 : 
            {
