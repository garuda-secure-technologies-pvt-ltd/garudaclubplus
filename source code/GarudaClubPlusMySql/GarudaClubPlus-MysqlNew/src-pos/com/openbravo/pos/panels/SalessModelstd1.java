...
public class SalessModelstd1  {
    ...
    private SalessModelstd1() {
    }    
    
    public static SalessModelstd1 emptyInstance() {
        
        SalessModelstd1 p = new SalessModelstd1();
    ...
    private static void calCategorywise(List<ProductsCategoryLine> list1,SalessModelstd1 p) throws BasicException{
        String pid=null;
        Double amt=0.0;
    ...
    private static void calculateCategoryWise(List<ProductsCategoryLine> list,SalessModelstd1 p) throws BasicException{
              String pid=null;
              Double amt=0.0;
    ...
    public static SalessModelstd1 loadInstance(AppView app,Date d) throws BasicException {
...
//                ,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.STRING})
               ,"SELECT D.QTITEMID,P.NAME,D.QTY,D.RATE,D.USER_ID,D.REASON,p.inventrymaintain "
                ...
                ,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.STRING})
                , new SerializerReadClass( SalessModelstd1.discountlist.class )).list(new Object[]{d,d1,app.getAppUserView().getUser().getWarehouse()});
...
//                +"WHERE   ROLES.ID=PEOPLE.ROLE AND P.ID=R.PRODUCT AND R.AUTHORISED=TRUE AND PEOPLE.NAME=R.CREATEDBY AND R.CRDATE <= ? AND ROLES.ID = ? AND R.CRDATE >= PEOPLE.OPENSALE "
                ...
                ,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                , new SerializerReadClass( SalessModelstd1.discountlist.class )).list(new Object[]{d,app.getAppUserView().getUser().getWarehouse()});
        ...
        if (disbill == null) {
           ...
           List disbillstk = new StaticSentence(app.getSession()
                ...
                //,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                , new SerializerReadClass( SalessModelstd1.discountlist.class )).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
     ...
     /*    List disqtstk = new StaticSentence(app.getSession()
        ...
        List salebillwise = new StaticSentence(app.getSession()
                ...
                //,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                , new SerializerReadClass( SalessModelstd1.SalesLine.class )).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
        ...
        if (salebillwise == null) {
         ...
         List taxCategorywise = new StaticSentence(app.getSession()
                ...
                //,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                , new SerializerReadClass( SalessModelstd1.TaxLine.class )).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
         ...
         * */
         ...
         List<ProductsCategoryLine> categorywise = new StaticSentence(app.getSession()
                ...
                //,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                , new SerializerReadClass( SalessModelstd1.ProductsCategoryLine.class )).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
         ...
         List productaccountwise = new StaticSentence(app.getSession()
                ...
                //,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                , new SerializerReadClass( SalessModelstd1.ProductsAccountLine.class )).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
        ...
        List pendingqt = new StaticSentence(app.getSession()
                ...
                ,new SerializerWriteBasic(new Datas[]{Datas.STRING})
                   // ,new SerializerWriteBasic(data)
                ,new SerializerReadClass(SalessModelstd1.QTLine.class)).list(new Object[]{app.getAppUserView().getUser().getWarehouse()});
...
*/      Object[] x = (Object[]) new StaticSentence(app.getSession()
        ...
        List pdtwise = new StaticSentence(app.getSession()
               ...
               // ,new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING})
                ,new SerializerWriteBasic(data)
                ,new SerializerReadClass(SalessModelstd1.ProductsLine.class)).list(params);//new Object[]{d,app.getAppUserView().getUser().getRole()});
