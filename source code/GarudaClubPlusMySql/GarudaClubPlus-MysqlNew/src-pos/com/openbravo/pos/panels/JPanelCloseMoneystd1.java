 ...
 * @author adrianromero
 */
public class JPanelCloseMoneystd1 extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    /*    m_jCash.setText(null);
     ...
     //   m_jotherincometable.setModel(new DefaultTableModel());
        ...
        // LoadData
        date =new Date();
        m_PaymentsToClose = PaymentsModelstd1.loadInstance(m_App,date);
        ...
        if (res == JOptionPane.YES_OPTION) {
           ...
           // try {
              ...
              //  m_dlSystem.execInsertCash(
                ...
                java.util.List<PaymentsModelstd1.RdetailsLine1> debtr=m_PaymentsToClose.getRdetalLines1();
               //warehouse changes - start
                for(PaymentsModelstd1.RdetailsLine1 r:debtr){
//                  String s1="RA";
//                  String s2="BA";
...
//                 }
               ...
               /* java.util.List<PaymentsModel.RdetailsLine1> debtr=m_PaymentsToClose.getRdetalLines1();
                ...
                Facility barfac=dlfac.getFacilitybyID("1");
                 ...
                 java.util.List<PaymentsModelstd1.OtherIncomeTotalLine> OIncome=m_PaymentsToClose.getOtherIncomeTotalLines();
                for(PaymentsModelstd1.OtherIncomeTotalLine o:OIncome){
                ...
                if(m_PaymentsToClose.getGuestFee()>0){
                    java.util.List<PaymentsModelstd1.GuestReceiptdetailsLine> guestDetails=m_PaymentsToClose.getGuestReceiptDetails();
                    for(PaymentsModelstd1.GuestReceiptdetailsLine line:guestDetails){
             ...
             for(PaymentsModelstd1.WarehouseTotals whTotals : m_PaymentsToClose.getWareHouseTotals()){
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        ChequeDetailstd1 cd=ChequeDetailstd1.getDialog(this, m_PaymentsToClose);
        try{
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try{
            ...
            e.printStackTrace();
             ...
             ChequeDetailstd1 cd=ChequeDetailstd1.getDialog(this, m_PaymentsToClose);
        try{
            cd.showDialog(m_PaymentsToClose.PendingCrConfTableModelstd(),false,"Details Of Pending Credit Confirmation");
        }catch(Exception e){
            e.printStackTrace();
        }
        }
