...
//    }
   ...
   private String getNextBillID() throws BasicException{
     ...
     Object[] obj=(Object[])new  StaticSentence(app.getSession()
            , "SELECT SEQUENCEDETAIL.BSERIES,SEQUENCEDETAIL.BMAX FROM SEQUENCEDETAIL,ROLES R WHERE SEQUENCEDETAIL.USERNAME=? AND SEQUENCEDETAIL.CATEGORY=? AND ACTIVE=TRUE"
     ...
     if(obj!=null){
         ...
         billnum=obj[0].toString()+ max.intValue();
          new StaticSentence(app.getSession()
                  ...
                  , "UPDATE SEQUENCEDETAIL SET BMAX=?  WHERE ACTIVE=TRUE AND USERNAME = ?  AND CATEGORY=?"
