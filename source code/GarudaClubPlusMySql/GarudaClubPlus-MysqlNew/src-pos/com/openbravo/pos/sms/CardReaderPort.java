...
import com.openbravo.pos.sms.SerialParameters;
 ...
 * @author swathi
 */
public class CardReaderPort implements SerialPortEventListener,
...
/*    private TextArea messageAreaOut;
    ...
    */
    public CardReaderPort(SerialParameters parameters) {
   ...
   */
   public void openConnection() throws SerialConnectionException, PortInUseException, UnsupportedCommOperationException {
	...
	// wants to.
	try {
	    sPort = (SerialPort)portId.open("CardReader", 30000);
