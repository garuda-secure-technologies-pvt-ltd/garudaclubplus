 ...
 * @author swathi
 */
public class Stocktransfer extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void initComponents() {
        ...
        add(jButton1);
        jButton1.setBounds(140, 120, 100, 23);
    ...
    public String getTitle() {
        ...
        return "Stock Transfer by Warehouse";
    }
    ...
    public void generateReport(Date from, Date to, String location) throws BasicException {
        ...
        Object[] values = new Object[]{from, to, location,location};
        wmodel = wmodel.loadInstancestocktransfer(m_App, values);
        launch(wmodel.getStocktransferdetails());
    ...
    private void launch(List<WaiterWiseTotalModel.StockTransferInfo> list) throws BasicException {
        ...
        DataSourceForStocktransfer ds = new DataSourceForStocktransfer(list);
        data1.setDataSource(ds);
        JasperPrint jp = JasperReportNew.runReport(m_App, "./reports/com/openbravo/reports/stocktransfernew.jrxml", reportparams, false, data1, true, null);
