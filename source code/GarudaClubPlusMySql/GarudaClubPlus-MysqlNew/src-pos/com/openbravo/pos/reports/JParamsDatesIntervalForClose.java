...
public class JParamsDatesIntervalForClose extends javax.swing.JPanel implements ReportEditorCreator {

    /** Creates new form JParamsClosedPos */
    public JParamsDatesIntervalForClose() {
        initComponents();
        setStartDate(LookupUtilityImpl.getInstance(null).getAppView().getAppUserView().getUser().getOpenCashTime());
        setEndDate(new Date());
    }
