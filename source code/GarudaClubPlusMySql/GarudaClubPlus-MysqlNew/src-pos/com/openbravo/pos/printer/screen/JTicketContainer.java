...
class JTicketContainer extends javax.swing.JPanel {
    ...
    public Dimension getPreferredSize() { 
        ...
        return new Dimension(iMaxx + 5 * H_GAP + ins.left + ins.right + 100 , iMaxy + ins.bottom);
    }
    ...
    public void addTicket(JTicket ticket) {
        ...
        doLayout();
        revalidate();
        scrollRectToVisible(new Rectangle(0, getPreferredSize().height - 1, 10, 1));
    }
