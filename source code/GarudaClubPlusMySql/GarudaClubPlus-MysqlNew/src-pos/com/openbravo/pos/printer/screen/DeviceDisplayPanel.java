...
public class DeviceDisplayPanel extends JPanel implements DeviceDisplay, DeviceDisplayImpl {
    ...
    public DeviceDisplayPanel(double dZoom) {
        ...
        jline1.setFont(new Font("Monospaced", Font.BOLD, (int)(22 * dZoom)));
        jline2.setFont(new Font("Monospaced", Font.BOLD, (int)(22 * dZoom)));
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.setPaint(new GradientPaint(getWidth() - i.left - i.right - 20, getHeight() - i.top - i.bottom - 50, getBackground()
