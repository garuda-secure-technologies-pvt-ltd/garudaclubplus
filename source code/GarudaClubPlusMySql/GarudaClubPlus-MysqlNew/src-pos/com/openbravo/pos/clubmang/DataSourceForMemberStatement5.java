 ...
 * @author swathi
 */
public class DataSourceForMemberStatement5 implements JRDataSource {
	private int m_nIdx;
	private List<MemberStatementModel4.Facilityline> v;



	public DataSourceForMemberStatement5() {
		this (new ArrayList<MemberStatementModel4.Facilityline>());
	}

	public DataSourceForMemberStatement5(List<MemberStatementModel4.Facilityline> v) {
		m_nIdx = -1;
		this.v = v;
	}
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		MemberStatementModel4.Facilityline curr = v.get(m_nIdx);
