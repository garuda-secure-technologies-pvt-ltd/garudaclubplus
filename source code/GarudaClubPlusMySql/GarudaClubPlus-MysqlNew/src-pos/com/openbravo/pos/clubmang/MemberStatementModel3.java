 ...
 * @author swathi
 */
     public class MemberStatementModel3 {
   ...
   private List< MemberStatementModel1> memberstatementmodel ;
    ...
    public  MemberStatementModel3()
   {
   }
    
  public static  MemberStatementModel3 emptyinstance()
  {
       MemberStatementModel3  d=new MemberStatementModel3(); 
     ...
     public static MemberStatementModel3 loadInstance(AppView app, String ID, String accid, DataLogicFacilities dlfac, Date fromdate, Date todate,String searchkey , int Flag) throws BasicException {
        MemberStatementModel3 d = new MemberStatementModel3();
        d.dlfac = dlfac;
        Date sdate = new Date();
        try {
        ...
        if(Flag==0){
                                        ...
                                        List dlist = new StaticSentence(app.getSession()//Added to replace above commented qry
                                                ...
                                                new SerializerReadClass(MemberStatementModel3.Facilityline.class)).list(new Object[]{Temp_todate , Temp_todate , accid});
                ...
                previousDues = new StaticSentence(app.getSession(),  "SELECT SUM(A.DEBIT) AS AMT1 , SUM(A.CREDIT) AS AMT2, 0.0 AS AMT3  , C.searchkey FROM AJPERIODTOTALS A , customers c WHERE A.EDATE < ? AND A.ACCOUNTID=? and a.accountid = c.account group by a.accountid order by c.searchkey",
                new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING }),
                new SerializerReadClass(MemberStatementModel3.amountline.class)).list(new Object[]{ todate,accid });
        ...
        else
        {
                ...
                previousDues = new StaticSentence(app.getSession(),  "SELECT SUM(A.DEBIT) AS AMT1 , SUM(A.CREDIT) AS AMT2, 0.0 AS AMT3  , C.searchkey FROM AJPERIODTOTALS A , customers c WHERE A.EDATE < ? AND A.ACCOUNTID=? and a.accountid = c.account group by a.accountid having amt1!='0.00'order by c.searchkey",
                new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.STRING }),
                new SerializerReadClass(MemberStatementModel3.amountline.class)).list(new Object[]{ todate,accid });
        ...
        List<addressline> adr = new StaticSentence(app.getSession(),
                "SELECT ADDRESS,ADDRESS2,POSTAL,CITY,SEARCHKEY,NAME,PHONE,PHONE2 FROM CUSTOMERS WHERE ACCOUNT=? order by searchkey",
                SerializerWriteString.INSTANCE,
                new SerializerReadClass(MemberStatementModel3.addressline.class)).list(accid);
        String addr = null;
   ...
   public static MemberStatementModel3 loadInstanceforAllMembers(AppView app, DataLogicFacilities dlfac, Date fromdate, Date todate,int Flag) throws BasicException {
        MemberStatementModel3 d = new MemberStatementModel3();
        d.dlfac = dlfac;
        Date sdate = new Date();
        try {
       ...
       System.out.println(Temp_todate);
        ...
        List<Object> Accid_List=new ArrayList<Object>();
            try {
           Accid_List = (List<Object>) new StaticSentence(app.getSession(), "SELECT c.account   FROM ajperiodtotals a, customers c where a.debit='0.00' and a.credit = '0.00' and a.edate= '2011-12-31 00:00:00' and a.accountid=c.account order by c.searchkey", SerializerWriteString.INSTANCE , SerializerReadString.INSTANCE ).list();
     ...
     if(Flag==1){       
                        ...
                        List dlist = new StaticSentence(app.getSession()//Added to replace above commented qry
                                ...
                                new SerializerReadClass(MemberStatementModel3.Facilityline.class)).list(new Object[]{Temp_todate  , Temp_todate , Temp_todate});

                      List dlist1 = new StaticSentence(app.getSession()//Added to replace above commented qry
                            , "SELECT 'No Transactions ' as NAME, ? as DUEDATE,'0.00' as AMOUNT,'--' as AID, '--' as TRANSNO, C.NAME as ACCOUNT, 'No Transactions' as NARRATION, ? as DATE, '' as FID, '0.00' as AMT, C.NAME as MEMNAME, C.SEARCHKEY as MEMNO, '' as TTYPE from customers c  WHERE  C.ACCOUNT  not in (select accountid from ajperiodtotals where edate = ?) GROUP BY C.ACCOUNT order by c.searchkey",
               ...
               previousDues = new StaticSentence(app.getSession(),  "SELECT SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) ) AS AMT1 , 0.00  AS AMT2, 0.00 AS AMT3  , C.searchkey FROM AJPERIODTOTALS A , customers c WHERE A.EDATE < ?  and a.accountid = c.account  group by a.accountid order by c.searchkey",
                new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP}),
                new SerializerReadClass(MemberStatementModel3.amountline.class)).list(new Object[]{ todate });
              ...
              List dlist = new StaticSentence(app.getSession()//Added to replace above commented qry
                                , "SELECT 'No Transactions ' as NAME, ? as DUEDATE, SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) ) AMOUNT,'--' as AID, '--' as TRANSNO, C.NAME as ACCOUNT, 'No Transactions' as NARRATION, ? as DATE, '' as FID, SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) ) as AMT, C.NAME as MEMNAME, C.SEARCHKEY as MEMNO, '' as TTYPE from customers c , AJPERIODTOTALS A WHERE A.ACCOUNTID = C.ACCOUNT AND C.ACCOUNT in (SELECT c.account   FROM ajperiodtotals a, customers c where  a.curdebit='0.00' and a.curcredit = '0.00' and a.edate= ?  and a.accountid=c.account order by c.searchkey) GROUP BY C.ACCOUNT HAVING SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) )!='0.00' order by c.searchkey",
           ...
           previousDues = new StaticSentence(app.getSession(),  "SELECT SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) ) AS AMT1 , 0.00  AS AMT2, 0.00 AS AMT3  , C.searchkey FROM AJPERIODTOTALS A , customers c WHERE A.EDATE <? and a.accountid = c.account AND C.ACCOUNT in (SELECT c.account   FROM ajperiodtotals a, customers c where   a.curdebit='0.00' and a.curcredit = '0.00' and a.edate<=?  and a.accountid=c.account order by c.searchkey)group by a.accountid having SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) )!=0.00  order by c.searchkey",
                new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP,Datas.TIMESTAMP}),
                new SerializerReadClass(MemberStatementModel3.amountline.class)).list(new Object[]{ Temp_todate,Temp_todate });
        ...
        List<addressline> adr = new StaticSentence(app.getSession(),
                ...
                null,
                new SerializerReadClass(MemberStatementModel3.addressline.class)).list();
        String addr = null;
        Map<String, String> adrmap = new HashMap<String, String>();
        if (adr != null) {
            for (addressline a : adr) {
   ...
   // LOAD FOR PERTICULAR MEMBER.... 
     public static MemberStatementModel3 loadInstance(AppView app, DataLogicFacilities dlfac, Date fromdate, Date todate, String memtype , int Flag) throws BasicException {
        MemberStatementModel3 d = new MemberStatementModel3();
        d.dlfac = dlfac;
        Date sdate = new Date();
        try {
      ...
      if(Flag==0){
                        ...
                        List dlist = new StaticSentence(app.getSession()//Added to replace above commented qry
                                ...
                                new SerializerReadClass(MemberStatementModel3.Facilityline.class)).list(new Object[]{Temp_todate  , Temp_todate , Temp_todate , memtype});


                       List dlist1 = new StaticSentence(app.getSession()//Added to replace above commented qry
                                , "SELECT 'No Transactions ' as NAME, ? as DUEDATE,'0.00' as AMOUNT,'--' as AID, '--' as TRANSNO, C.NAME as ACCOUNT, 'No Transactions' as NARRATION, ? as DATE, '' as FID, '0.00' as AMT, C.NAME as MEMNAME, C.SEARCHKEY as MEMNO, '' as TTYPE from customers c  WHERE c.memtype=? and  C.ACCOUNT  not in (select accountid from ajperiodtotals where edate = ?) GROUP BY C.ACCOUNT order by c.searchkey",

                               new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP , Datas.TIMESTAMP ,Datas.STRING ,  Datas.TIMESTAMP  }),
                              new SerializerReadClass(MemberStatementModel3.Facilityline.class)).list(new Object[]{Temp_todate  , Temp_todate ,memtype , Temp_todate });
                ...
                previousDues= new StaticSentence(app.getSession(),  "SELECT SUM( (A.DEBIT+A.CURDEBIT) - (A.CREDIT+A.CURCREDIT) ) AS AMT1 , 0.00  AS AMT2, 0.00 AS AMT3  , C.searchkey FROM AJPERIODTOTALS A , customers c WHERE A.EDATE < ?  and a.accountid = c.account group by a.accountid HAVING AMT1!='0.00' order by c.searchkey",
                new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP}),
                new SerializerReadClass(MemberStatementModel3.amountline.class)).list(new Object[]{ todate });
        ...
        List<addressline> adr = new StaticSentence(app.getSession(),
                ...
                SerializerWriteString.INSTANCE,
                new SerializerReadClass(MemberStatementModel3.addressline.class)).list(memtype);
        String addr = null;
        Map<String, String> adrmap = new HashMap<String, String>();
        if (adr != null) {
            for (addressline a : adr) {
    ...
    public List getAccountId_Having_nullTrans(AppView app) throws BasicException {
        ...
        dateto = fedate;*/
           try {
           Mem_id_AJ = (List<Object>) new StaticSentence(app.getSession(), "SELECT c.account   FROM ajperiodtotals a, customers c where a.debit='0.00' and a.credit = '0.00' and a.edate= '2011-12-31 00:00:00' and a.accountid=c.account order by c.searchkey", SerializerWriteString.INSTANCE , SerializerReadString.INSTANCE ).list();
