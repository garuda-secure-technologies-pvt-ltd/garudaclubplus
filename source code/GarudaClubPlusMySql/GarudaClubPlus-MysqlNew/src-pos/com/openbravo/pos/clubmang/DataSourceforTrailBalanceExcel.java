 ...
 * @author swathi
 */
public class DataSourceforTrailBalanceExcel implements JRDataSource{
     private int m_nIdx;
	private List<AccountReportsExcel.TrailBalanceData> v;


	public DataSourceforTrailBalanceExcel() {
		this (new ArrayList<AccountReportsExcel.TrailBalanceData>());
	}

  

	public DataSourceforTrailBalanceExcel(List<AccountReportsExcel.TrailBalanceData> v) {
		m_nIdx = -1;
		this.v = v;
	}
  /*  public List<AccountReports.ReportData>  getFieldValue(JRField field) throws JRException {
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		AccountReportsExcel.TrailBalanceData curr = v.get(m_nIdx);
