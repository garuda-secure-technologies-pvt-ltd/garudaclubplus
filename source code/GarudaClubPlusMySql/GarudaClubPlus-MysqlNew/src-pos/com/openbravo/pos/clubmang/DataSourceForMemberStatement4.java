 ...
 * @author swathi
 */
public class DataSourceForMemberStatement4 implements JRDataSource {
	private int m_nIdx;
	private List<MemberStatementModel3.Facilityline> v;



	public DataSourceForMemberStatement4() {
		this (new ArrayList<MemberStatementModel3.Facilityline>());
	}

	public DataSourceForMemberStatement4(List<MemberStatementModel3.Facilityline> v) {
		m_nIdx = -1;
		this.v = v;
	}
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		MemberStatementModel3.Facilityline curr = v.get(m_nIdx);
