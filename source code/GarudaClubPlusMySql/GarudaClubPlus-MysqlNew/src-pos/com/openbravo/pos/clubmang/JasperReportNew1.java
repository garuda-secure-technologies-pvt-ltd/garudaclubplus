 ...
 * @author User
 */
public class JasperReportNew1 {
    public static JasperPrint runReport(AppView app,String reportFile,Map reportparams,boolean print,DataSourceProvider1 data1,boolean display,String filename) {
