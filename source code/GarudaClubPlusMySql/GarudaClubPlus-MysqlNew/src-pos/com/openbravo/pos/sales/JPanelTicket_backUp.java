 ...
 * @author adrianromero
 */
public abstract class JPanelTicket_backUp extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
...
///aaa                       
                ...
                o1.toString();
                 m_jTotalEuros.setText(Formats.CURRENCY.formatValue(new Double(o1.toString())));
                  ...
                  m_jTotalEuros.setText(m_oTicket.printTotal());
                    ...
                    Logger.getLogger(JPanelTicket_backUp.class.getName()).log(Level.SEVERE, null, ex);
                }
                  } 
    ...
    private void printTicket(String sresourcename, TicketInfo ticket, Object ticketext) {
        ...
        if (sresource == null) {
            ...
            msg.show(JPanelTicket_backUp.this);
        } else {
            try {
                boolean flag = m_App.getAppUserView().getUser().hasPermission("Bar Counter");
    ...
    public class ScriptObject {
        ...
        public double getInputValue() {
            if (m_iNumberStatusInput == NUMBERVALID && m_iNumberStatusPor == NUMBERZERO) {
                return JPanelTicket_backUp.this.getInputValue();
            } else {
                return 0.0;
            }
        }
        ...
        public void printReport(String resourcefile) {
            JPanelTicket_backUp.this.printReport(resourcefile, ticket, ticketext);
        }

        public void printTicket(String sresourcename) {
            JPanelTicket_backUp.this.printTicket(sresourcename, ticket, ticketext);
        }
    ...
    private void m_jListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jListActionPerformed
        ...
        ProductInfoExt prod = JProductFinder.showMessage(JPanelTicket_backUp.this, dlSales);
        if (prod != null) {
