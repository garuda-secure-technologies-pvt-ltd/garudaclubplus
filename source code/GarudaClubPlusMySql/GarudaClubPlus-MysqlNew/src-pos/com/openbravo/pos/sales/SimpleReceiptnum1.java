 ...
 * @author  adrian
 */
public class SimpleReceiptnum1 extends javax.swing.JPanel {
    ...
    public boolean ct_f1 = false;
    
    /** Creates new form SimpleReceipt */
    public SimpleReceiptnum1(String ticketline, DataLogicSales dlSales, DataLogicCustomers dlCustomers, TaxesLogic taxeslogic) {        
        
        initComponents();
        
        btnCustomer.addActionListener(new ActionListener(){  //code for QT
...
btnCustomer.setToolTipText("CTRL F");
