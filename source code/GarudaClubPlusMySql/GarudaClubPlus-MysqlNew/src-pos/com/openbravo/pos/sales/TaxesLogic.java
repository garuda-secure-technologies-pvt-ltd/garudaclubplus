...
//    added by shweta
     public double getTaxRate(TaxCategoryInfo1 tc1) {
        return getTaxRate(tc1, null);
    }
       public double getTaxRate(TaxCategoryInfo2 tc2) {
        return getTaxRate(tc2, null);
    }
//    
...
//    added by shweta
    public double getTaxRate(TaxCategoryInfo1 tc1, CustomerInfoExt customer) {
        
        if (tc1 == null) {
            return 0.0;
        } else {
            return getTaxRate(tc1.getID(), customer);          
        }
    }
    public double getTaxRate(TaxCategoryInfo2 tc2, CustomerInfoExt customer) {
        
        if (tc2 == null) {
            return 0.0;
        } else {
            return getTaxRate(tc2.getID(), customer);          
        }
    }
//    
...
//    public TaxInfo getTaxInfo1(String tcid) {
//        return getTaxInfo(tcid, null);
//    }
...
//    added by shweta
     public TaxInfo getTaxInfo(TaxCategoryInfo1 tc1) {
        return getTaxInfo(tc1.getID(), null);
    }  
      public TaxInfo getTaxInfo(TaxCategoryInfo2 tc2) {
        return getTaxInfo(tc2.getID(), null);
    }  
//    
...
//    added by shweta
    public TaxInfo getTaxInfo(TaxCategoryInfo1 tc1, CustomerInfoExt customer) {  
        return getTaxInfo(tc1.getID(), customer);
    }  
     public TaxInfo getTaxInfo(TaxCategoryInfo2 tc2, CustomerInfoExt customer) {  
        return getTaxInfo(tc2.getID(), customer);
    }  
//    
...
//    public TaxInfo getTaxInfo(TaxCategoryInfo1 tinfo1) {
