...
public class BillLineInfo implements SerializableWrite, SerializableRead, Serializable{
    ...
    public void writeValues(DataWrite dp) throws BasicException {
        ...
        setGtax2cas(m_product.getBASIC2());
        setGtax3cas(m_product.getBASIC3());
...
//        this.gtax2id = gttax2id;
//    }
//
//    public String getGtax2cas() {
//        return gtax2cas;
//    }
//
//    public void setGtax2cas(String gtax2cas) {
...
//        
//        this.gtax3id = gttax3id;
//    }
//
//    public String getGtax3cas() {
//        return gtax3cas;
//    }
//
//    public void setGtax3cas(String gtax3cas) {
...
//    }
//
//    public void setGtax3(double gtax3) {
//        this.gtax3 = gttax3;
//    }
// guru getter setter end
...
//ended by guru for tax insertion to billitem table
    ...
    private void refreshAttributes() {
        ...
        if(m_product.getTaxCategoryID2()!=null){
...
//        System.out.println("return m_amount * getTaxRate()::  "+ m_amount * tax.getRate());
//        return m_amount * tax.getRate();
//    }
//    public double getTax2() {
//        System.out.println("return m_amount * getTaxRate()::  "+ m_amount * tax2.getRate());
//        return m_amount * tax2.getRate();
//    }
//    public double getTax3() {
//        System.out.println("return m_amount * getTaxRate()::  "+ m_amount * tax3.getRate());
//        return m_amount * tax3.getRate();
//    }
    ...
    public Boolean getProductBasic2(){
      if(attributes.getProperty("product.BASIC2")!=null || attributes.getProperty("product.BASIC2").trim().length()>1)  { 
    ...
    public Boolean getProductBasic3(){
        if(attributes.getProperty("product.BASIC3")!=null || attributes.getProperty("product.BASIC3").trim().length()>1)  { 
