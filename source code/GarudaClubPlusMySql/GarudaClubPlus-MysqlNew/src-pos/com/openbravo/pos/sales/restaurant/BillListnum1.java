 ...
 * @author 
 */
public class BillListnum1 extends javax.swing.JDialog {
    ...
    private DataLogicFacilities dlfac;
     public static boolean cat_ps = false;
     public boolean pb = true;
     public static boolean cancel = true;
     public static boolean re_discount = true;
     public static boolean dispose_esc = true;

    /** Creates new form BillListnum1 */
    public BillListnum1(java.awt.Frame parent, DataLogicSales dlSales, BillLogic blogic, CustomerInfo customer) {
        super(parent, true);
    ...
    public BillListnum1(java.awt.Dialog parent, DataLogicSales dlSales, BillLogic blogic, CustomerInfo customer) {
        super(parent, true);
        this.dlSales = dlSales;
        this.blogic = blogic;
        this.customer = customer;
    ...
    public static BillListnum1 getDialog(Component parent, DataLogicSales dlSales, BillLogic blogic, CustomerInfo customer) {

        Window window = getWindow(parent);

        BillListnum1 mybilllogic;

        if (window instanceof Frame) {
            mybilllogic = new BillListnum1((Frame) window, dlSales, blogic, customer);
        } else {
            mybilllogic = new BillListnum1((Dialog) window, dlSales, blogic, customer);
        }
        ...
        try {
            ...
            if (i >= 0 && i < blist.size()) {
                ...
                if (obj != null) {
                    ...
                    Billpagenum1 billpage = Billpagenum1.getDialog(this, dlSales, null, b.getCustomer(),0);
                    billpage.init(b);
                    billpage.showDialog();
                    refreshModel();
                }
    ...
    private void initComponents() {
        ...
        jTable1 = new javax.swing.JTable(){
            ...
            jTable2 = new javax.swing.JTable(){
                ...
                jTable1.setNextFocusableComponent(jScrollPane2);
                ...
                jTable2.setNextFocusableComponent(jScrollPane1);
                ...
                jButton1.setToolTipText("CTRL S");
