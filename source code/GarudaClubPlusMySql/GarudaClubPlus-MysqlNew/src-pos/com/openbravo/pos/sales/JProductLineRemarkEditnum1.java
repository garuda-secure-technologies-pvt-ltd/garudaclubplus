 ...
 * @author swathi
 */
public class JProductLineRemarkEditnum1 extends javax.swing.JDialog {

    /** Creates new form JProductLineRemarkEdit */
     private boolean m_bok;
    private TicketLineInfo m_oLineTicket;

    private JProductLineRemarkEditnum1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
       // initComponents();
    }
     private JProductLineRemarkEditnum1(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
        ...
        public boolean dispatchKeyEvent(KeyEvent e){  
          ...
          {  
            if((e.getKeyCode() == KeyEvent.VK_ESCAPE)  )
                 ...
                 CancelR();  
            JIntroPageRestnum1.remark = true;
          }  
          return false;}}); 

jButton1.setToolTipText("F1");
       
jButton2.setToolTipText("ESCAPE");
    ...
    public static boolean showMessage(Component parent, AppView app, TicketLineInfo oLine) {
        ...
        JProductLineRemarkEditnum1 myMsg;
        if (window instanceof Frame) {
            myMsg = new JProductLineRemarkEditnum1((Frame) window, true);
        } else {
            myMsg = new JProductLineRemarkEditnum1((Dialog) window, true);
        }
