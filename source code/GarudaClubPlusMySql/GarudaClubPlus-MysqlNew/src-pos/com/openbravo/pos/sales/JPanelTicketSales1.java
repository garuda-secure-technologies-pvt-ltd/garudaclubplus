...
public class JPanelTicketSales1 extends JPanelTicketstd1{

    private CatalogSelector m_cat;
   
    /** Creates a new instance of JPanelTicketSales */
    public JPanelTicketSales1() {
    ...
    protected JTicketsBagstd1 getJTicketsBag() {
        return JTicketsBagstd1.createTicketsBag(m_App.getProperties().getProperty("machine.ticketsbag"), m_App, this);
    }
    ...
    public void activate() throws BasicException {      
        ...
        m_cat.loadCatalog(allCategories);// loads category in bottom left
    }      
