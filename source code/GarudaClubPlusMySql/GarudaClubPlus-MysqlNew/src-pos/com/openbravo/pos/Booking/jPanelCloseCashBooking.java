...
public class jPanelCloseCashBooking extends javax.swing.JPanel implements JPanelView, BeanFactoryApp{
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Collection Adj against Other Bills :");
        jPanel2.add(jLabel12);
        jLabel12.setBounds(10, 400, 210, 14);

        receipttotal.setEditable(false);
        jPanel2.add(receipttotal);
        receipttotal.setBounds(230, 400, 130, 20);

        jLabel13.setText("Collection Total (B):");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(10, 190, 160, 14);

        debtctotal.setEditable(false);
        jPanel2.add(debtctotal);
        debtctotal.setBounds(180, 190, 130, 20);

        jLabel14.setText("Debt Raised Total (D):");
        jPanel2.add(jLabel14);
        jLabel14.setBounds(10, 280, 160, 14);

        debtraised.setEditable(false);
        jPanel2.add(debtraised);
        debtraised.setBounds(180, 280, 130, 20);

        jLabel15.setText("Other Income (C) :");
        jPanel2.add(jLabel15);
        jLabel15.setBounds(10, 240, 160, 14);

        otherincometotal.setEditable(false);
        jPanel2.add(otherincometotal);
        otherincometotal.setBounds(180, 240, 130, 20);

        jLabel16.setText("Balance (A+B+C-D-E) :");
        jPanel2.add(jLabel16);
        jLabel16.setBounds(10, 360, 160, 14);

        balance.setEditable(false);
        jPanel2.add(balance);
        balance.setBounds(180, 360, 130, 20);
        ...
        jButton3.setBounds(370, 400, 90, 23);
        ...
        jButton4.setBounds(320, 190, 90, 23);
        ...
        jButton5.setBounds(320, 240, 90, 23);
        ...
        jButton6.setBounds(320, 280, 90, 23);

        jLabel19.setText("Payments/cash out (E):");
        jPanel2.add(jLabel19);
        jLabel19.setBounds(10, 320, 140, 14);

        paymentout.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                paymentoutActionPerformed(evt);
            }
        });
        jPanel2.add(paymentout);
        paymentout.setBounds(180, 320, 130, 20);
        ...
        jButton7.setBounds(320, 320, 90, 23);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ChequeDetail2 cd=ChequeDetail2.getDialog(this, m_PaymentsToClose);
        try{
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        ChequeDetail2 cd=ChequeDetail2.getDialog(this, m_PaymentsToClose);
        try{
            boolean flag=  cd.showDialog(m_PaymentsToClose.getPaymentsModel2(),true,"Details Of Payment Made");
        }catch(Exception e){
            e.printStackTrace();
        }
                ...
                public Object transact() throws BasicException {
                    ...
                    if (res == JOptionPane.YES_OPTION) {
                       ...
                       //double credittotal=m_PaymentsToClose.getReceipttotalsum()+m_PaymentsToClose.getotherIncomeTotal1();
                        double credittotal=m_PaymentsToClose.getotherIncomeTotal1() - m_PaymentsToClose.getpayTotal() ;   // EDITED BY AKASH ------------------------------------------------------------------------------------------------------------------------------
                        ...
                        if(debittotal==credittotal){   //Arun
                            ...
                            // try {
                                if (m_App.getActiveCashDateEnd() == null) {
                                    ...
                                    java.util.List<PaymentsModel2.RdetailsLine1> debtr=m_PaymentsToClose.getRdetalLines1();
                                    //warehouse changes - start
                                    for(PaymentsModel2.RdetailsLine1 r:debtr){
                                        //                  String s1="RA";
                                        //                  String s2="BA";
                                    ...
                                    java.util.List<PaymentsModel2.OtherIncomeTotalLine> OIncome=m_PaymentsToClose.getOtherIncomeTotalLines();
                                    for(PaymentsModel2.OtherIncomeTotalLine o:OIncome){
                                    ...
                                    if(m_PaymentsToClose.getGuestFee()>0){
                                        java.util.List<PaymentsModel2.GuestReceiptdetailsLine> guestDetails=m_PaymentsToClose.getGuestReceiptDetails();
                                        for(PaymentsModel2.GuestReceiptdetailsLine line:guestDetails){
                                    ...
                                    if(m_PaymentsToClose.getcountercount()>0){
                                        for(PaymentsModel2.WarehouseTotals whTotals : m_PaymentsToClose.getWareHouseTotals()){
                                        ...
                                        * */
                                        ...
                                        // new PreparedSentence(m_App.getSession()
                                            ...
                                            new PreparedSentence(m_App.getSession()
                                            , "UPDATE room_hall_refund_voucher SET CLOSECASH=?  WHERE CLOSECASH IS NULL AND REFUND_BY=? "
                                            , new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.STRING})).exec(new Object[]{m_App.getAppUserView().getUser().getName()+" : "+m_PaymentsToClose.printSequence(),m_App.getAppUserView().getUser().getName()});
    ...
    private void paymentoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentoutActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_paymentoutActionPerformed

    
    private void printPayments(String remark) {
        
        String sresource = m_dlSystem.getResourceAsXML("Printer.CloseCashBooking");
        if (sresource == null) {
    ...
    private class FormatsPayment extends Formats {
     ...
     private void loadData() throws BasicException {
       ...
       // m_jMinDate.setText(null);
        ...
        date =new Date();
        m_PaymentsToClose = PaymentsModel2.loadInstance(m_App,date);
    ...
    public String getTitle() {
        return AppLocal.getIntString("Close Cash");
    }
