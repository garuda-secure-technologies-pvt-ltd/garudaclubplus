...
public class DataSourceForBilledReports_Halls implements JRDataSource {
    private int m_nIdx;
    ...
    public boolean next() throws JRException {
      ...
      public DataSourceForBilledReports_Halls(List<BilledReportsTableModel.HallBillInfo> v) {
		m_nIdx = -1;
		this.v = v;
     }
             ...
             if(sName.equals("BillNo"))
              ...
              o = curr.getBOOKING_SEQ_NO();
                ...
                else if (sName.equals("GuestName"))  
                {
                    ...
                    o = (curr.getRATE()+curr.getTAX_TOTAL());
