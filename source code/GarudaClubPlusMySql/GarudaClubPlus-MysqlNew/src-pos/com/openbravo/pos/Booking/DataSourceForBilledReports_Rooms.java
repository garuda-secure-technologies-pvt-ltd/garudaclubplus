...
public class DataSourceForBilledReports_Rooms  implements JRDataSource  {
    private int m_nIdx;
    ...
    public boolean next() throws JRException {
     ...
     public DataSourceForBilledReports_Rooms(List<BilledReportsTableModel.RoomBillInfo> v) {
		m_nIdx = -1;
		this.v = v;
     }
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
	   ...
	   return null;
          ...
          else if (sName.equals("GuestName"))  
          {
              ...
              o = curr.getRATE()+curr.getTAX_TOTAL()+curr.getRM_SERV_AMT();
