 ...
 * @author swathi
 */
public class dueListNoticeTable extends javax.swing.JDialog implements JPanelView, BeanFactoryApp {

    /** Creates new form dueListTable */
    private List<Facility> rflist;
    private DueListNoticeTableModel dmodel;
    private AppView m_App;
    private Date date;
    private String header;
    private String secretary;
    private String treasurer;
      public dueListNoticeTable(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        jSpinner1.setModel(new SpinnerNumberModel(1, 1, 3, 1));
    ...
    protected dueListNoticeTable(Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public dueListNoticeTable(Frame parent,AppView app,Date d,String header,String sec,String tre) {
        this(parent, false);
        this.m_App=app;
        this.date=d;
        this.header=header;
    ...
    public dueListNoticeTable(Dialog parent,AppView app,Date d,String header,String sec,String tre) {
        this(parent, false);
        this.m_App=app;
        this.date=d;
        this.header=header;
    ...
    public static dueListNoticeTable getDialog(Component parent,AppView app,Date d,String header,String sec,String tre) {

        Window window = getWindow(parent);

        dueListNoticeTable ct;

        if (window instanceof Frame) {
            ct = new dueListNoticeTable((Frame) window,app,d,header,sec,tre);
        } else {
            ct = new dueListNoticeTable((Dialog) window,app,d,header,sec,tre);
        }

        return ct;
    }

    public dueListNoticeTable(java.awt.Frame parent, boolean modal,Date d,String header,String sec,String tre) {
        super(parent, modal);
        initComponents();
//        jSpinner1.setModel(new SpinnerNumberModel(1, 1, 3, 1));
...
//        jButton1.setEnabled(false);
    ...
    public void showDialog(DueListNoticeTableModel dmodel,List<Facility> rflist,AppView m_App){
       this.rflist=rflist;
       this.m_App=m_App;
