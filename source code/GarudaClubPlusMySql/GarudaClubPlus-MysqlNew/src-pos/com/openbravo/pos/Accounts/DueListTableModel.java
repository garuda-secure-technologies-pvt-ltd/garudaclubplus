...
public class DueListTableModel {
   ...
   public static DueListTableModel loadData(AppView app,String fname,String memtypeid,Date date,Date overduedate,DataLogicFacilities dlfac,String fid) throws BasicException{
       DueListTableModel d=new DueListTableModel();
       String query=null;
