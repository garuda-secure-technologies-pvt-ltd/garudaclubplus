...
public class ProductFilterSalesnum1 extends javax.swing.JPanel implements EditorCreator {
    
    private SentenceList m_sentcat;
    private ComboBoxValModel m_CategoryModel;
    
    /** Creates new form ProductFilterSales */
    public ProductFilterSalesnum1(DataLogicSales dlSales, JEditorKeys jKeys) {
        initComponents();
    ...
    private void initComponents() {
        ...
        m_jtxtName.setNextFocusableComponent(m_jCategory);
        add(m_jtxtName);
        ...
        m_jCategory.setNextFocusableComponent(m_jCboPriceBuy);
        ...
        m_jCboPriceBuy.setNextFocusableComponent(m_jPriceSell);
        add(m_jCboPriceBuy);
        ...
        m_jCboPriceSell.setNextFocusableComponent(m_jtxtName);
        add(m_jCboPriceSell);
        m_jCboPriceSell.setBounds(130, 130, 150, 20);
        add(m_jPriceSell);
        m_jPriceSell.setBounds(290, 130, 130, 25);

        m_jtxtBarCode.setNextFocusableComponent(m_jtxtName);
        add(m_jtxtBarCode);
