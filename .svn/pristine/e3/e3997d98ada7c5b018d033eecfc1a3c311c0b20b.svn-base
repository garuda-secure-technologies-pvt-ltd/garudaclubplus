...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.openbravo.pos.pda.struts.beans.BalanceInfo; "  %>
	...
	windowOnloadFunction(panelOneObjList, panelTwoObjList, advPanelListt)
     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"  > 
                                ...
                                <marquee behavior="alternate"> 
                                    ...
                                    <tr>
                                        <th>
                                      	...
                                      	<div style="color:lime; font-size: x-large; text-align: center; font-weight: bolder;" >
                <%BalanceInfo binfo = (BalanceInfo) request.getSession().getAttribute("binfo");

                %>
                <p " >Welcome   ${binfo.name},<br><br>
        ...
        if (binfo.getBal() > 0) {
            ...
            <a href='showTransaction.action'><img src="resources/transactions.png" onmouseover="this.src='resources/transactions_mo.png';" onmouseout="this.src='resources/transactions.png';" alt="Transactions" /></a>
