                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <s:form name = "submitNewPassword" action="submitNewPassword.action" method="post" theme="simple" >    
								...
								<input type="password" name="bean.opass"  theme="simple"  id="keyboard" name="login" value="" class="keyboardInput" onfocus="enable()" style="width: 250px; height: 25px;  margin-right: 300px; border:5px outset #545565;"/>
