...
//            }
           ...
           // d.setTime(cal.getTimeInMillis());
            d1.setTime(cal.getTimeInMillis());
            dmodel=DueListTableModel.loadData(m_App,fname,memtypeid,d,d1,dlfac,fid);
            String header=jTextArea1.getText();
            String sec=jTextField3.getText();
            String tre=jTextField4.getText();
            dueListTable duetable=dueListTable.getDialog(this, m_App,duedate,header,sec,tre,fid);
