...
public class OfferTableDetail {
    private List<Offerline> ol;
     private final static String[] OFFERHEADERS = {"Product","Buy Qty","Buy Rate","Get Qty","Get Rate","From","To","Active"};
...
//String[] arr=o1.toString().split(" ");
     ...
     List dlist = new StaticSentence(app.getSession()
                ,"SELECT P.NAME,BUYQTY,BUYRATE,GETQTY,GETRATE,FROMDATE,TODATE,ACTIVE,OFFER.ID "
        ...
        return new AbstractTableModel() {
            ...
            public Object getValueAt(int row, int column) {
                ...
                switch (column) {
                    ...
                    case 1: return l.getbuyqty();
                     case 2: return l.getbuyrate();
                    case 3 : return l.getGetqty();
                    case 4: return l.getGetrate();
                    case 5: return l.getStartdate();
                    case 6: return l.getEnddate();
                    case 7:return l.getactive();
                    case 8:return l.getoid();
