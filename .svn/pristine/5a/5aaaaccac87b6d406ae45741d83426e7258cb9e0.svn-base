 ...
 * AJEditor.java
 *
 * Created on 05-Apr-2011, 12:15:49
 */
...
public class AJEditor extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {

    private AppView app;
    private AJTableModel pjEditorTableModel;
    ...
    public void activate() throws BasicException {
        pjEditorTableModel = AJTableModel.emptyInstance();
    ...
    private void getAJDetail(String id) throws BasicException {
    }

    private void loadData() {
        try {
            pjEditorTableModel = AJTableModel.loadData(app, (Date) Formats.DATE.parseValue(jTextField1.getText()), (Date) Formats.DATE.parseValue(jTextField2.getText()));
            jTable1.setModel(pjEditorTableModel.getTableModel());
