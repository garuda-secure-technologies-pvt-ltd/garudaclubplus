...
public class JPanelCloseSaleTable extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    //private List<AllRoles> rolelist;
        ...
        try {
            ...
            if (fromDate.getText().isEmpty() == true && toDate.getText().isEmpty() == true) {
               ...
               AllRoles role= (AllRoles) roles.getSelectedItem();
                s=(String) role.getName();         
                System.out.println(s);
                if("Bar Counter".equals(s) || "Counter role".equals(s))
                {
                ...
                {
                    JOptionPane.showMessageDialog(this, " select roles, those have sales permission");
                }
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            DataSourceProvider data1 = new DataSourceProvider(dbmodel.getsaleList());
            data1.setFields(getFields());
            ClosedSaleDataSource1 ds = new ClosedSaleDataSource1(dbmodel.getsaleList());
            data1.setDataSource(ds);
            reportparams.put("closedsaledatasource1", ds);
            JasperPrint jp = JasperReportNew.runReport(m_App, "./reports/com/openbravo/reports/ClosedSaleReport_1.jrxml", reportparams, false, data1, true, null);
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            ...
            if (evt.getClickCount() == 2) {
                ...
                cal2.set(Calendar.SECOND,59);
                cal2.set(Calendar.MILLISECOND,59);
                String role = (String) dbmodel.getTableModel().getValueAt(row, 0);
                String sequence = (String) dbmodel.getTableModel().getValueAt(row, 5);
                String id = sequence + " : " + role;
