...
<html>
    ...
    <head>
        ...
        <title img src="resources/Garuda.png"  size ="1" border="0"/>This Page Is Under Construction</title>
...
<link rel=StyleSheet href="css/mystyle.css" type='text/css'>
   ...
   window.onload = function(){
     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"  > 
       ...
       <img alt="This PAge is Under Construction..!!!" src="resources/UnderConstruction.gif">
