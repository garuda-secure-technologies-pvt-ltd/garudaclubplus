...
//        m_jMode.addActionListener(new MyKeyNumberListener('\u0010')); 
    ...
    private void initComponents() {
        ...
        m_jKey8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jKey8ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private void m_jKey8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jKey8ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_m_jKey8ActionPerformed
