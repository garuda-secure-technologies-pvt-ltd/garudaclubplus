     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"   > 
        ...
        <table border="0" >
                 <tr>
                     ...
                     <img src="img\<s:property value="#session.home.logoPath"/>" title="Visit Club Web Site...!!! " class="clogo" alt="<s:property value="#session.home.desc"/>"/>
                     </s:a>
                     </th>
                              ...
                              <tr style="height: 65%">
                                  <th><font size="5" style="color: olive;" > 
                                                  Please Swipe your Card or Click here to <br/> Login With Password<br/>
                                                    ...
                                                    <img src="resources/loginPassword.jpg" title="Login Using Password" style="border:6px outset #545565; width: 120px; height: 120px; "  onclick="location.href='loginPage.action'" />
                                                    </br>
                                            </th>
