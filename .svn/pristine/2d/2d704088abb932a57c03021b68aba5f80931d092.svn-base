     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"  > 
        ...
        <table border="1" style="height: 100px" >
                ...
                <table>
                    ...
                    <tr style="height: 65%">
                       <th>
                            <s:form name="DeactivateFacilityForm" action="deactivatefacility.action" method="post" >
                            
 <center>

    <%ArrayList<ActiveFacility> actfac = (ArrayList<ActiveFacility>) request.getSession().getAttribute("activefacility");
...
int i=0;
    ...
    <table border="2" align="left" style=" background-color:activeborder; color: blue;" >
        ...
        <tr><td colspan="4" align="center" style=" font: bold; ">Standard Facilities</td></tr>
        ...
        <tr><td colspan="4" align="center" style="font: bold;">Opt.Facilities</td></tr>
        <tr><th></th><th title="FacilityName"style="">Fac.Name</th><th title="Renewal Amount">Rn.Amt</th><th title="Status">Status</th></tr>
        ...
        <tr>
            ...
            <td><%=a.getStatus()%> </td>
            <% } else {
    request.getSession().setAttribute("mfuid", a.getMfuId());%>
            <td> <%=a.getStatus()%><a href=cancel.action?id=<%=a.getMfuId()%> ><p><font colour="blue">Cancel</font></p></a> </td>
            <%}%>
        </tr>
        <%
                }
    ...
    <tr>
        <th> 
                ...
                <br/>
    							...
    							<div>
								<div class="label"><s:text   name="Deactivation Req Date:"/></div>>
								<div class="input"><input type="text" name="bean.searchkey"  theme="simple"  id="keyboard" name="submit" value="" onmouseover="keyUsername()" style="width: 150px; height: 30px; border:5px outset #545565;"/></div>
								<div style="color: red; font: bold;" ><s:text name="(dd/mm/yyyy)"></s:text></div>
        ...
        <tr>
            <th>
              ...
              <center>
                    <img src="resources/deactivate.png" title="Click here to send Request to Deactive selected facilities." onmouseover="this.src='resources/deactivate_mo.png';" onmouseout="this.src='resources/deactivate.png';" style="position: relative; margin-left: 15%; " onclick="DeactivateFacilityForm.submit()" />&nbsp;&nbsp;
