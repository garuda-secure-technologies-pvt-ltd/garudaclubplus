...
public class DataSource1 implements JRDataSource {
    ...
    private Date edate;
    private Date sdate;
    private List<AccountReports.AccountsList> v1;
    ...
    public DataSource1(List<AccountReports.AccountsList> v, Date date, Date date1,List<AccountReports.AccountsList> v1) {
        m_nIdx = -1;
        m_nIdx1 = -1;
        this.v = v;
        edate = date;
