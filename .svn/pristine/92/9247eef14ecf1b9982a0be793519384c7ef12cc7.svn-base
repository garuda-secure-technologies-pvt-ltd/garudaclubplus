 ...
 * @author swathi
 */
public class DataSourceForMemberStatement2 implements JRDataSource {
	private int m_nIdx;
	private List<MemberStatementModel1.Facilityline> v;



	public DataSourceForMemberStatement2() {
		this (new ArrayList<MemberStatementModel1.Facilityline>());
	}

	public DataSourceForMemberStatement2(List<MemberStatementModel1.Facilityline> v) {
		m_nIdx = -1;
		this.v = v;
	}
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		MemberStatementModel1.Facilityline curr = v.get(m_nIdx);
