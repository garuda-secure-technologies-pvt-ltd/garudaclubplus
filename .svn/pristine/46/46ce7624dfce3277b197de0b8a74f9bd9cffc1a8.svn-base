 ...
 * @author swathi
 */
public class IncomeAndExpenditureAccount extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public IncomeAndExpenditureAccount() {
        initComponents();
    }
     public String getTitle() {
        return "Income And Expenditure Statement";
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
        ...
        add(jButton3);
        jButton3.setBounds(360, 90, 140, 23);
        add(jScrollPane1);
        jScrollPane1.setBounds(10, 120, 670, 470);
        ...
        add(jButton4);
        jButton4.setBounds(520, 90, 160, 23);
        ...
        add(jButton5);
        jButton5.setBounds(210, 90, 140, 23);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
           ...
           tree.getTree().addTreeWillExpandListener(new TreeWillExpandListener() {
            ...
            {
                JOptionPane.showMessageDialog(null, "Please select start and end dates ", "", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        FinancialReportPrinter frp=new FinancialReportPrinter(clogic.getMap(), tree.getTree(), m_App,false, clogic.getSdate(), clogic.getEdate(),"Income And Expenditure Account");
