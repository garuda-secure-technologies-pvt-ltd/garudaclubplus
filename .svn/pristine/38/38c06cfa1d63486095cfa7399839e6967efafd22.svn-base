...
import com.openbravo.pos.admin.CardReaderPortNumber;
import java.io.File;
...
public class JPanelConfiguration extends JPanel implements JPanelView {
    ...
    private void saveProperties() {
        ...
        // paneles auxiliares
        //SHIV:ADDDED 3LINES to save these lines in garudapos property file even after configuration change
         config.setProperty("ACScard.port","" );
         config.setProperty("card.portnumber","");
         config.setProperty("cardAccessOnly", "false"); 
         /////////SHIV:END OF 3LINES
        for (PanelConfig c: m_panelconfig) {
