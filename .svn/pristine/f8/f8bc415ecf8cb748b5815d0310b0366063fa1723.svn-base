...
public class AppUser {
    ...
    public AppUser(String id,String name,String role,String cash,String cheque)
    {
        m_sId=id;
        m_sName=name;
        m_sRole=role;
     ...
     public AppUser(String id,String name,String role)
    {
        m_sId=id;
        m_sName=name;
        m_sRole=role;
    ...
    public AppUser(String id, String name, String password, String card, String role, Icon icon, Date lastLoginTime, Date openCashTime, Date closeCashTime, Date closesaletime, Date openSaleTime,String cash,String cheque) {
        m_sId = id;
        m_sName = name;
