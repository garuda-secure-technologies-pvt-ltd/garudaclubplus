     ...
     <body style="text-align: center; widows: inherit; background-image: url(resources/backgroundImage.jpg) " id="body"  > 
       ...
       <table border="0" >
        ...
        for (TransactionInfo t : transactions) {
            ...
            <a href="logout.action"><img src="resources/logoutm.png" onmouseover="this.src='resources/logoutm_mo.png';" onmouseout="this.src='resources/logoutm.png';" alt="LogOut"/> </a><br/>
