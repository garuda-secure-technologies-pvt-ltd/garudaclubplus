 ...
 * @author swathi
 */
public class CreditConfirmationTableModel extends AbstractTableModel{
//  public class BillListTableModel extends AbstractTableModel{
   ...
   // private List<BillInfo> m_rows;
    ...
    public CreditConfirmationTableModel (List<CreditConfirmList> list) {
        this.list=list;
    }

    public void refresh(List<CreditConfirmList> list) {
        this.list=list;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        CreditConfirmList i = list.get(rowIndex);
        switch(columnIndex) {
