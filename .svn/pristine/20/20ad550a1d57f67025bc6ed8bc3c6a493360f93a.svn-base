...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    //private DataLogicFacilities m_dlSales;
    ...
    public void loadCatalog(java.util.List<CategoryInfo> categories) throws BasicException {
      ...
      /*  java.util.List<CategoryInfo> categories ;
       // if(sm.warehousename==null)
      //   categories = m_dlSales.getRootCategories();
     // if(sm.warehousename==null)
         categories = m_dlSales.getRootCategories();*/

     //   else
     //      categories = m_dlSales.getParticularCategories(sm.warehousename);
        ...
        try {
          ...
          /*      int flag1=0;
                ...
                String wid="";
                 ...
                 {
                 Object[] obj1=(Object[]) new StaticSentence(ses,
                "SELECT ID FROM  WHERE NAME = ? AND PARENTID IS NULL"
                , SerializerWriteString.INSTANCE
                ,new SerializerReadBasic(new Datas[] { Datas.STRING})).find(sm.warehousename);
                ...
                if(obj!=null || obj[0]!=null)
                {
                    ...
                    prcat=new String[1];
              //  if (CategoryInfo cat : categories)
                // {
                     if(obj!=null && obj[0]!=null)
                    {
