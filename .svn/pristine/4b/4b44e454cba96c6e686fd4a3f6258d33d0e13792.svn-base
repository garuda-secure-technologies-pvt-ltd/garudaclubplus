...
public class DataSourceForMemberStatement implements JRDataSource {
	private int m_nIdx;
	private List<MemberStatementModel.Facilityline> v;



	public DataSourceForMemberStatement() {
		this (new ArrayList<MemberStatementModel.Facilityline>());
	}

	public DataSourceForMemberStatement(List<MemberStatementModel.Facilityline> v) {
		m_nIdx = -1;
		this.v = v;
	}
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		MemberStatementModel.Facilityline curr = v.get(m_nIdx);
