...
public class DataSourceForNoticeToMembersOtherThanFirst implements JRDataSource {
	...
	private List<DueListNoticeTableModel.Facilityline2> v;
        private List<DueListNoticeTableModel.NoticeTrackedBean> v1;
	...
	public DataSourceForNoticeToMembersOtherThanFirst() {
		this (new ArrayList<DueListNoticeTableModel.Facilityline2>(), new ArrayList<DueListNoticeTableModel.NoticeTrackedBean>());
             
	}

	public DataSourceForNoticeToMembersOtherThanFirst(List<DueListNoticeTableModel.Facilityline2> v, List<DueListNoticeTableModel.NoticeTrackedBean> v1) {
		m_nIdx = -1;
		this.v = v;
                this.v1 = v1;
	...
	public Object getFieldValue(JRField field) throws JRException {
		...
		if (curr== null)
			return null;
                ...
                {
                    ref = curr.getMemNo();
                    for (Iterator<DueListNoticeTableModel.NoticeTrackedBean> it = v1.iterator(); it.hasNext();) {
                        DueListNoticeTableModel.NoticeTrackedBean noticeTB = it.next();
                        if(ref.equals(noticeTB.getMemSearchKey()))
                        {
                            ntb = noticeTB;
                            break;
                        }
