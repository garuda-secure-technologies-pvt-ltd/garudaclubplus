  ...
  /*  private Date getDate(Date d){
   ...
   //  private int flag=0;
     ...
     private void TobyKeyPressed(java.awt.event.KeyEvent evt,int index) throws BasicException{
       ...
       private void updateaccountjournaldup() throws BasicException{
          String id=null;
       ...
       //   if(vedit==false){
           ...
           for(JTextField toby: Tobylist){
                   ...
                   if(cashieracc.contains(accid)){
                     ...
                     , new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING})).exec(new Object[]{UUID.randomUUID().toString(),tid,appuser.getId(),appuser.getcashaccount(),appuser.getId()});
                   }
                 }
              i++;
             }
      ...
      private void updateaccountjournal() throws BasicException{
          String id=null;
           String tid=UUID.randomUUID().toString();
          if(credittotal.getText().equals(debittotal.getText())){
              if(vedit==true){
    ...
    private void initComponents() {
        ...
        credittotal.setBounds(510, 10, 110, 20);

        jLabel10.setText("Total");
        jPanel3.add(jLabel10);
        jLabel10.setBounds(0, 10, 90, 14);

        debittotal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel3.add(debittotal);
        debittotal.setBounds(380, 10, 110, 20);
        ...
        jPanel4.add(jLabel1);
        jLabel1.setBounds(10, 50, 140, 14);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel4.setText("Receipt");
        jPanel4.add(jLabel4);
        jLabel4.setBounds(150, 20, 70, 20);

        jLabel7.setText("Date ");
        jPanel4.add(jLabel7);
        jLabel7.setBounds(340, 10, 50, 14);

        jLabel8.setText("jLabel8");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(420, 10, 210, 14);

        jLabel2.setText("Debit");
        jPanel4.add(jLabel2);
        jLabel2.setBounds(400, 50, 70, 14);

        jLabel3.setText("Credit");
        jPanel4.add(jLabel3);
        jLabel3.setBounds(540, 50, 70, 14);
        ...
        jPanel4.add(jLabel9);
        jLabel9.setBounds(410, 30, 210, 20);
