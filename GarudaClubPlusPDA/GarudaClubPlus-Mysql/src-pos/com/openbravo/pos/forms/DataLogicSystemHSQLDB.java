...
public class DataLogicSystemHSQLDB extends DataLogicSystem {
    ...
    public void init(Session s) {
        ...
        m_peoplevisible = new StaticSentence(s
            , "SELECT ID, NAME, APPPASSWORD, CARD, ROLE, IMAGE, LOGINTIME, OPENCASHTIME, CLOSECASHTIME, OPENSALE, CLOSESALE,CASHACCOUNT,CHEQUEACCOUNT FROM PEOPLE WHERE VISIBLE = TRUE ORDER BY NAME "
            , null
            , peopleread);   
