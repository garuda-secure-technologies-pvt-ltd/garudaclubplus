        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(facilitytype, javax.swing.GroupLayout.Alignment.TRAILING, 0, 201, Short.MAX_VALUE)
                            .addComponent(mno, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                        .addGap(10, 10, 10)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(sdate, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(m_depnamelist, 0, 161, Short.MAX_VALUE)
                    .addComponent(mname, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ftype, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(38, 38, 38)
         ...
         //  if(mno.getText().toUpperCase().equals(customerInfo.getSearchkey().toUpperCase())){
            ...
            if(memdep.isSelected()){
             ...
             int count=Integer.valueOf(new StaticSentence(m_App.getSession()
                    ,"SELECT COUNT(*) FROM MEMFACILITYUSAGE WHERE MEMNO=? AND FACILITYTYPE=? AND USERID=? AND ACTIVE=TRUE"
                    ,new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.STRING,Datas.STRING})
                    ,SerializerReadInteger.INSTANCE).find(new Object[]{customerInfo.getId(),facility.getid(),user}).toString());
            if(count==0){
                ...
                if(facility.getjamt()>0){
                 ...
                 double taxamt=Math.floor(taxrate*facility.getjamt());
                  if(taxamt>0){
                   ...
                   Object[] value4=new Object[]{UUID.randomUUID().toString(),tid,d,"C",facility.getid(),billno,taxamt,d,true,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),"Service tax on Join Fees for "+facility.getName(),servicetaxacc,0.0,d,new Date(),true};
                 ...
                 Object[] value1=new Object[]{UUID.randomUUID().toString(),tid,d,"C",facility.getid(),billno,facility.getjamt(),d,true,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),facility.getName(),facility.getJoinfeeAccount(),0.0,d,true};
                 dmang.insertintoaccjoutnal1(value1);
                 Object[] value2=new Object[]{UUID.randomUUID().toString(),tid,customerInfo.getId(),d,"D",facility.getid(),billno,tjamt,d,false,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),jnarration,caccount,tjamt,true};
              ...
              if(ramt>0){
                 ...
                 double taxamt=Math.floor(taxrate*ramt);
                  if(taxamt>0){
                   ...
                   Object[] value4=new Object[]{UUID.randomUUID().toString(),tid,d,"C",facility.getid(),billnum,taxamt,d,true,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),"Service tax on Renewal Fees for "+facility.getName(),servicetaxacc,0.0,d,new Date(),true};
                   dmang.insertintoaccjoutnal3(value4);
                  }
                 ...
                 Object[] value1=new Object[]{UUID.randomUUID().toString(),tid,d,"C",facility.getid(),billnum,ramt,d,true,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),facility.getName(),facility.getRenewalacc(),0.0,d,true};
                 dmang.insertintoaccjoutnal1(value1);
                 Object[] value2=new Object[]{UUID.randomUUID().toString(),tid,customerInfo.getId(),d,"D",facility.getid(),billnum,tramt,duedate,false,m_App.getAppUserView().getUser().getName(),m_App.getProperties().getHost(),rnarration,caccount,tramt,true};
                 dmang.insertintoaccjoutnal(value2);
                 dmang.updatebillno(facility.getid());
                 totalamt+=tramt;
                }
                ...
                if(p.getqbtype()==false){
                  Object[] value=new Object[]{UUID.randomUUID().toString(),true,customerInfo.getId(),facility.getid(),sdatetime,m_App.getAppUserView().getUser().getName(),d,0,user};
                   new PreparedSentence(m_App.getSession()
                   , "INSERT INTO MEMFACILITYUSAGE(ID, ACTIVE, MEMNO, FACILITYTYPE, SDATE, CREATEDBY, CRDATE,STATUS_,USERID) VALUES (?,?,?,?,?,?,?,?,?)"         //praveen:changed status to status_
                   , new SerializerWriteBasic(new Datas[]{Datas.STRING, Datas.BOOLEAN, Datas.STRING,  Datas.STRING, Datas.TIMESTAMP,Datas.STRING, Datas.TIMESTAMP,Datas.INT,Datas.STRING})
                   ).exec(value);
                }else{
                   Object[] value=new Object[]{UUID.randomUUID().toString(),true,customerInfo.getId(),facility.getid(),sdatetime,m_App.getAppUserView().getUser().getName(),d,edate,d,billnum,0,user};
                   new PreparedSentence(m_App.getSession()
                   , "INSERT INTO MEMFACILITYUSAGE(ID, ACTIVE, MEMNO, FACILITYTYPE, SDATE, CREATEDBY, CRDATE,LBILLDATE,NBILLDATE,BILLREF,STATUS_,USERID) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)"    //praveen:changed status to status_
                   , new SerializerWriteBasic(new Datas[]{Datas.STRING, Datas.BOOLEAN, Datas.STRING,  Datas.STRING, Datas.TIMESTAMP,Datas.STRING, Datas.TIMESTAMP, Datas.TIMESTAMP, Datas.TIMESTAMP,Datas.STRING,Datas.INT,Datas.STRING})
                   ).exec(value);
                }
         ...
         try{
            ...
            if(row < jTable1.getRowCount() && row >= 0){
               ...
               if(JOptionPane.showConfirmDialog(this, "Do you want to deactivate "+fname+" facility for "+mname1+" ?",null ,JOptionPane.YES_NO_OPTION )==JOptionPane.YES_OPTION){
                   new PreparedSentence(m_App.getSession()
                             ,"UPDATE MEMFACILITYUSAGE SET ACTIVE=FALSE,DEACTIVATEDBY =?,DEACTIVATEDDATE=? WHERE ID=?"
