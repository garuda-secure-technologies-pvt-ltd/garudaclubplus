...
public class PeopleView extends JPanel implements EditorRecord {
   ...
   // private SentenceList m_sentacc;
    ...
    public PeopleView(AppView app,DataLogicAdmin dlAdmin, DirtyManager dirty) {
       ...
       // accounttype.addActionListener(dirty);
       // chequeacctype.addActionListener(dirty);
      ...
      if(cashinhand==null && chequeinhand==null){
           ...
           people[8]=id;
            Object obj1[]=(Object[])new StaticSentence(m_App.getSession()
                                        ...
                                        ,SerializerWriteString.INSTANCE
                                        ,new SerializerReadBasic(new Datas[]{Datas.STRING})).find("1.1.1.2");
            if(obj1==null || obj1[0]==null){
                        ...
                        // searchkey1=cashacc.getSerachkey()+"0001";
                         ...
                         int temp=(Integer.parseInt(obj1[0].toString()) + 1);
                         searchkey="1.1.1.2"+temp;
           ...
           if(obj2==null || obj2[0]==null){
                        ...
                        // searchkey1=cashacc.getSerachkey()+"0001";
                         ...
                         int temp=(Integer.parseInt(obj1[0].toString()) + 1);
                         searchkey1="1.1.1.2"+temp;
                        // searchkey1=String.valueOf(temp+1);
                     }


         Object[] value1=new Object[]{id1,searchkey1,"Cheque in hand "+m_jName.getText(),"Cheque in hand "+m_jName.getText(),"Asset","D",false,false,"1.1.1.2","S",dnow,0.0,true};
         new PreparedSentence(m_App.getSession()
                  , "INSERT INTO ACCOUNTMASTER(ID,SEARCHKEY,NAME,DESCRIPTION,TYPE_,SIGN,DOCUMENT,SUMMARY,PARENT,LEVEL_,STARTDATE,OPENINGBALANCE,ACTIVE) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)"
                  , new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING,Datas.STRING,Datas.BOOLEAN,Datas.BOOLEAN,Datas.STRING,Datas.STRING,Datas.TIMESTAMP,Datas.DOUBLE,Datas.BOOLEAN})
                  ).exec(value1);
    ...
    public void activate() throws BasicException {
      ...
      //  chequeacctype.setModel(cheaccModel);
        AppView m_App=LookupUtilityImpl.getInstance(null).getAppView();
    ...
    private void initComponents() {
        ...
        add(m_jVisible);
        m_jVisible.setBounds(120, 120, 140, 20);

        jLabel3.setText(AppLocal.getIntString("label.peoplevisible")); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(20, 120, 90, 14);
        ...
        add(m_jImage);
        m_jImage.setBounds(110, 160, 230, 170);
        ...
        add(jComboBox1);
        jComboBox1.setBounds(310, 350, 150, 20);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(110, 350, 170, 140);
        ...
        add(jButton4);
        jButton4.setBounds(310, 390, 60, 23);

        add(jComboBox2);
        jComboBox2.setBounds(310, 430, 150, 20);
        ...
        add(jButton5);
        jButton5.setBounds(310, 470, 90, 23);
